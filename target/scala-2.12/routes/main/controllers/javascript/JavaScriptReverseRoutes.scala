...
package controllers.javascript {
  ...
  class ReverseUserController(_prefix: => String) {
    ...
    def deleteUser: JavaScriptReverseRoute = JavaScriptReverseRoute(
      ...
      """
        function(phone0) {
          return _wA({method:"GET", url:"""" + _prefix + { _defaultPrefix } + """" + "users/" + encodeURIComponent((""" + implicitly[play.api.mvc.PathBindable[String]].javascriptUnbind + """)("phone", phone0)) + "/"})
        }
      """
    )
    ...
    def done: JavaScriptReverseRoute = JavaScriptReverseRoute(
      "controllers.UserController.done",
      """
        function(phone0) {
          return _wA({method:"POST", url:"""" + _prefix + { _defaultPrefix } + """" + "users/" + encodeURIComponent((""" + implicitly[play.api.mvc.PathBindable[String]].javascriptUnbind + """)("phone", phone0))})
        }
      """
    )
